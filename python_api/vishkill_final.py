...
- Focus on scam types: phishing, tech support, IRS, fake prizes, impersonation etc
- Red flags: urgency, requests for money/personal infom, or any common scam indicators
